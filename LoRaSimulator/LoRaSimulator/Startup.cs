...
{
    using LoRaSimulator.Extensions;
    ...
    public class Startup
    {
        ...
        {
            services.AddSimulatorService();
            services.AddSimulatorDataAccessLayer(Configuration);
            services.AddControllers();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "LoRaSimulator", Version = "v1" });
            });
        }
